...
export function ArtistDiscussion({ artistId, comments }: { artistId: string; comments: (ArtistComment & { author: Profile | null })[] }) {
  ...
  function submit() {
    ...
    startTransition(async () => {
      await postArtistComment(artistId, text);
      setText("");
      router.refresh();
    });
  }
    ...
    <div className="rounded-xl border border-[#eeeeee] bg-white p-4">
      ...
      <div className="mt-3 flex items-center gap-1.5">
        <input
          ...
          placeholder="Discuss this artist… use @Name to mention someone"
          disabled={pending}
